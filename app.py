...
GEMINI\_API\_URL = f"[https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash\:generateContent?key={GEMINI\_API\_KEY}](https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key={GEMINI_API_KEY})"
